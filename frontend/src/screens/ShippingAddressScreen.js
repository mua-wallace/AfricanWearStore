        ...
        <div>
            <CheckoutSteps step1 step2 ></CheckoutSteps> 
             ...
             <div>
                ...
                <input type="text"  id="postalCode" placeholder="Enter Poastal Code" value={postalCode} onChange={(e) => setPostalCode(e.target.value)} required>
                </input>
             </div>
             <div>
                <label htmlFor="country">Country</label>
                <input type="text"  id="country" placeholder="Enter Coontry" value={country} onChange={(e) => setCountry(e.target.value)} required>
                </input>
             </div>
                <div>
                <label />
